...
st.write('The aim of the Explore app is to enable scientists to explore molecular 3D visualizations as well as bring attention to global disease trends.')
