...
from apps import home, chdis, inutero, infec, drugres, negtrop, mol3d, zoo # import your app modules here
...
st.write('The aim of the Explore app is to enable scientists to explore molecular 3D visualizations as well as bring attention to global disease research trends.')
...
app.add_app("Infectious Diseases", infec.app)
app.add_app("Neglected Tropical Diseases", negtrop.app)
app.add_app("Neurological Diseases", neuro.app)
